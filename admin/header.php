    ...
    <nav class="bg-indigo-600 shadow-lg sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-14 md:h-16">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="flex items-baseline space-x-4">
                            <a href="index.php"
                                class="<?php echo navClass('index.php', $current_page); ?>">Dashboard</a>
                            <a href="manage_students.php"
                                class="<?php echo navClass('manage_students.php', $current_page); ?>">Siswa</a>
                            <a href="manage_classes.php"
                                class="<?php echo navClass('manage_classes.php', $current_page); ?>">Kelas</a>
                ...
                <div class="flex items-center gap-3">
                    <span class="text-indigo-100 text-sm hidden sm:block">Halo,
                        <strong><?php echo htmlspecialchars($username); ?></strong></span>
                    <a href="../logout.php"
                        class="bg-indigo-700 hover:bg-indigo-800 text-white p-1.5 md:p-2 rounded-full transition-colors text-sm"
                        title="Logout">
        ...
        <div class="md:hidden hidden bg-indigo-700 border-t border-indigo-500 shadow-xl" id="mobileMenu">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <a href="index.php" class="<?php echo navClass('index.php', $current_page); ?>"><i
                        class="fas fa-tachometer-alt w-6 text-center"></i> Dashboard</a>
                <a href="manage_students.php" class="<?php echo navClass('manage_students.php', $current_page); ?>"><i
                        class="fas fa-users w-6 text-center"></i> Siswa</a>
                <a href="manage_classes.php" class="<?php echo navClass('manage_classes.php', $current_page); ?>"><i
                        class="fas fa-chalkboard w-6 text-center"></i> Kelas</a>
                <a href="manage_tests.php" class="<?php echo navClass('manage_tests.php', $current_page); ?>"><i
                        class="fas fa-file-alt w-6 text-center"></i> Ujian</a>
                <a href="manage_question_bank.php"
