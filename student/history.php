...
// =======================================================================
// PERBAIKAN FINAL: Query diubah untuk join langsung ke retake_requests
// berdasarkan ID hasil ujian (result_id) untuk akurasi yang lebih baik.
// =======================================================================
$sql = "SELECT 
            tr.id as result_id,
            t.id as test_id,
                    ...
                    <?php while ($row = $history->fetch_assoc()): ?>
                        <tr class="border-b">
                            ...
                            <td class="py-3 px-4 text-center">
                                ...
                                <?php
                                // Logika ini sekarang akan bekerja dengan benar karena query sudah diperbaiki.
                                if ($row['retake_mode'] == 1) { // Mode: Remedial (Perlu Persetujuan)
                                    ...
                                    if ($status == 'pending') {
                                        ...
                                        // Tombol akan muncul jika belum pernah ada request untuk hasil ini (status is NULL)
